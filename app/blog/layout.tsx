...
function CopyButton() {
  ...
  return (
    <button
      ...
      className="font-base flex items-center gap-1 text-center text-sm text-black/60 transition-colors dark:text-white/60"
      type="button"
    >
